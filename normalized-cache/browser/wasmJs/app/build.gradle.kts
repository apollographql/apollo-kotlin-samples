  ...
  sourceSets {
    wasmJsMain {
      ...
      dependencies {
        ...
        implementation("com.apollographql.cache:normalized-cache-sqlite:1.0.0-beta.4")
...
apollo {
  service("main") {
    ...
    plugin("com.apollographql.cache:normalized-cache-apollo-compiler-plugin:1.0.0-beta.4") {
